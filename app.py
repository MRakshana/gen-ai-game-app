...
# ------------------ HELPER FUNCTIONS ------------------ #
# The visualize_structure_enhanced function is removed to avoid Graphviz dependency.
# If you want to include a static image of the graph, you would generate it locally
# and then use st.image() to display it.
...
def main():
    ...
    st.write("Game flow visualization is not available in this deployed version.")
    # If you have a static image:
    # try:
    #     img = Image.open('game_state_machine.png')
    #     st.image(img)
    # except FileNotFoundError:
    #     st.error("Graph visualization image not found.")
